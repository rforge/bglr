...
summary.BGLR.ff=function(object,...)
{
...
residuals.BGLR.ff=function(object,...)
{
    if(!inherits(object, "BGLR")) stop("This function only works for objects of class `BGLR'")
	object$y-object$yHat
}

predict.BGLR.ff=function(object,newdata,...)
{
    if (!inherits(object, "BGLR")) stop("This function only works for objects of class `BGLR'")
	object$yHat
}

effects.BGLR.ff=function(object,...){
    if(!inherits(object, "BGLR")) stop("This function only works for objects of class `BGLR'")
	object$ETA	
}

plot.BGLR.ff=function(x,...)
{
